...
from .open_access import arxiv_papers, biorxiv_papers, chemrxiv_papers, pubmed_papers
from .physics import get_aps_papers as aps
from .crossref import retrieve_crossref_publications as crossref
from .databases import google_scholar_papers as google_scholar
            ...
            while True:
                ...
                while datetime.now() < end_time: # hour on
                    for paper in self.combined:
                        # get embedding
                        paper['embedding'] = translate(self.SciBERT.embed(f'{paper.get("title","")}: \n{paper.get("summary","")}'))
